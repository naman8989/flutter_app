...
import 'package:food_order_ui/server/mongo/crud.dart';

class RegisterButton extends StatefulWidget {
  var toSendData;
  RegisterButton({Key? key, this.toSendData}) : super(key: key);
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            // print(widget.toSendData);
            // mainMongodb('Register', widget.toSendData);
            // fetchmain();
            registerData();
            print('something');
            setState(() {
